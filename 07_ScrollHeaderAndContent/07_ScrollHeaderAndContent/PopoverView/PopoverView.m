...
//        }
        !_selectedBlock? : _selectedBlock(indexPath.row);
...
- (void)drawRect:(CGRect)rect {
    ...
    CGContextMoveToPoint(context, 0, curSize.height);//起点
    CGContextAddLineToPoint(context, curSize.width/2, 0);//折点
    CGContextAddLineToPoint(context, curSize.width, curSize.height);//终点
